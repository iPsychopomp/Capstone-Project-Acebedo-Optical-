...
Partial Public Class DataSet7
    ...
    Partial Public Class DataTable1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Overloads Function AddDataTable1Row(ByVal orderID As Integer, ByVal supplierName As String, ByVal orderDate As Date, ByVal totalAmount As Decimal, ByVal status As String, ByVal orderedBy As String) As DataTable1Row
            Dim rowDataTable1Row As DataTable1Row = CType(Me.NewRow, DataTable1Row)
            Dim columnValuesArray() As Object = New Object() {orderID, supplierName, orderDate, totalAmount, status, orderedBy}
...
Namespace DataSet7TableAdapters
    ...
    Partial Public Class DataTable1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT * FROM db_vieworderproducts"
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As DataSet7.DataTable1DataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As DataSet7.DataTable1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet7.DataTable1DataTable = New DataSet7.DataTable1DataTable()
